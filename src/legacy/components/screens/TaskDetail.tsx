...
const CADModal = dynamic(() => import("@legacy/components/cad/CADModal"), { ssr: false });
import { Button } from "@legacy/components/ui/Button";
import { PanelGlass } from "@legacy/components/ui/PanelGlass";
import { StarBadge } from "@legacy/components/ui/StarBadge";
import { CodeValidator } from "@legacy/components/task/CodeValidator";
import { HelpCards } from "@legacy/components/task/HelpCards";
import { TaskImage } from "@legacy/components/task/TaskImage";
import { useGameState } from "@legacy/components/providers/GameStateProvider";
import { findTask, isDailyChallengeTask, hasClaimedDailyChallengeToday, getAdjacentTaskId } from "@legacy/lib/tasks";
import { REWARD_CONFIG } from "@legacy/lib/rewards";
