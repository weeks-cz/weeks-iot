...
import { getComponentSpec } from "@legacy/lib/cad/components";
import { PIN_HIT_AREA, PITCH } from "@legacy/lib/cad/constants";
import { snapToGrid } from "@legacy/lib/cad/circuit";
import type { CircuitComponent, PinRef } from "@legacy/types/cad";
