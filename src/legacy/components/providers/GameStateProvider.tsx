...
import type { GameState, PerStudentAccount, SectionId, SyncableState, ThemeId } from "@legacy/types";
import type { Circuit } from "@legacy/types/cad";
import {
  ...
  loadGameState,
  saveGameState,
} from "@legacy/lib/storage";
import { applyTheme } from "@legacy/lib/themes";
import {
  computeTaskReward,
  awardStars,
  addToken,
  ...
  deductStars,
  computeLevelBadges,
} from "@legacy/lib/rewards";
import { MAX_STUDENTS_LIMIT, SECTION_UNLOCK_COSTS, STYLE_SHOP_CONFIG } from "@legacy/lib/config";
import { findTask, isDailyChallengeTask, hasClaimedDailyChallengeToday, getDailyChallengeTaskId } from "@legacy/lib/tasks";
import { isTopicEnabled } from "@legacy/lib/topics";
import { useAuth } from "@legacy/contexts/AuthContext";
import { fetchCloudState, emitEvent, syncToCloud } from "@legacy/lib/cloud-sync";
